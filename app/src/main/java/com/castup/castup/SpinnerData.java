...
public class SpinnerData {
    ...
    public static final String [] ChooseGender = {"Choose gender" , "Male" ,"Female"};


    public static final String[] ChooseCountry = {"Choose Country","Afghanistan", "Albania",
            "Algeria", "Andorra", "Angola", "Antarctica", "Argentina",
            "Armenia", "Aruba", "Australia", "Austria", "Azerbaijan",
            "Bahrain", "Bangladesh", "Belarus", "Belgium", "Belize", "Benin",
            "Bhutan", "Bolivia", "Bosnia And Herzegovina", "Botswana",
    ...
    public static final String[] ChooseLangudage = {"Choose language",
